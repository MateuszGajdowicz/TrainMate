...
function FilterTrainingsContainer({favouritesTrainigsList,periodOFTrainings,SeparateTrainings,trainingsList,trainingOptions,setDisplayedTrainingList,displayedTrainingsList}){
    ...
    function handleFavsDisplay(){
        if(!isFavsDisplayed){
            ...
            setDisplayedTrainingList(favouritesTrainigsList)
        }
        else{
